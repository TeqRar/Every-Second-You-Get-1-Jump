...
title.Text = "Every Second You Get +1 Jump Power Gui"
...
Basic.Text = "Teleport Last Island"
...
Infinite.Text = "Teleport Last Island [While]"
...
local function UMTQ_fake_script() -- Teleport.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
       ...
       local _150 = CFrame.new(153625.90625, 102665.2265625, 295.9056396484375 )
       Character.HumanoidRootPart.CFrame = _150
       wait(.1)
...
local function EKBNYI_fake_script() -- While Teleport.LocalScript 
